...
function setupSettings() {
    ...
    for (const name of sortedNames) {
        ...
        let sectionRootElt = mainElt.querySelector(`div.namespace-${namespace}`);
        if (sectionRootElt == null)
            sectionRootElt = createSection(namespace).root;
