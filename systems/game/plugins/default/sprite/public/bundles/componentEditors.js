...
function importComponent(entry, projectClient, nodeId, callback) {
    projectClient.editAsset(SupClient.query.asset, "addComponent", nodeId, "SpriteRenderer", null, (componentId) => {
        projectClient.editAsset(SupClient.query.asset, "editComponent", nodeId, componentId, "setProperty", "spriteAssetId", entry.id, callback);
    });
}
...
},{"./SpriteRendererEditor":1,"./importSpriteIntoScene":2}]},{},[3]);
