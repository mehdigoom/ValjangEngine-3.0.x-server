(function() {
    ...
    3: [function(require, module, exports) {
        ...
        (function() {
            ...
            // Change for ValjangEngine: expose THREE.js
            ...
            THREE.TransformGizmoTranslate = function() {
                ...
                this.handleGizmos = {
                    ...
                    Z: [
                        [new THREE.Mesh(arrowGeometry, new GizmoMaterial({ color: 0x0000ff })), [0, 0, 0.5],
                            [Math.PI / 2, 0, 0]
                        ],
                    ...
                    XYZ: [
                        [new THREE.Mesh(new THREE.OctahedronGeometry(0.1, 0), new GizmoMaterial({ color: 0xffffff, opacity: 0.25 })), [0, 0, 0],
                            [0, 0, 0]
                        ]
                    ],
                    ...
                    YZ: [
                        [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.29, 0.29), new GizmoMaterial({ color: 0x00ffff, opacity: 0.25 })), [0, 0.15, 0.15],
                            [0, Math.PI / 2, 0]
                        ]
                    ],

                    XZ: [
                        [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.29, 0.29), new GizmoMaterial({ color: 0xff00ff, opacity: 0.25 })), [0.15, 0, 0.15],
                            [-Math.PI / 2, 0, 0]
                        ]
                    ]
                ...
                this.pickerGizmos = {
                    ...
                    X: [
                        [new THREE.Mesh(new THREE.CylinderGeometry(0.2, 0, 1, 4, 1, false), pickerMaterial), [0.6, 0, 0],
                            [0, 0, -Math.PI / 2]
                        ]
                    ],
                    ...
                    Z: [
                        [new THREE.Mesh(new THREE.CylinderGeometry(0.2, 0, 1, 4, 1, false), pickerMaterial), [0, 0, 0.6],
                            [Math.PI / 2, 0, 0]
                        ]
                    ],
                    ...
                    YZ: [
                        [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), pickerMaterial), [0, 0.2, 0.2],
                            [0, Math.PI / 2, 0]
                        ]
                    ],

                    XZ: [
                        [new THREE.Mesh(new THREE.PlaneBufferGeometry(0.4, 0.4), pickerMaterial), [0.2, 0, 0.2],
                            [-Math.PI / 2, 0, 0]
                        ]
                    ]
            ...
            THREE.TransformGizmoRotate = function() {
                ...
                this.pickerGizmos = {
                    ...
                    X: [
                        [new THREE.Mesh(new THREE.TorusGeometry(1, 0.12, 4, 12, Math.PI), pickerMaterial), [0, 0, 0],
            ...
            THREE.TransformControls = function(camera, domElement) {
                ...
                function intersectObjects(pointer, objects) {
                    ...
                    // Change for ValjangEngine: Setup based on camera.type
    ...
    }, { "./GridHelper": 1, "./SelectionBox": 2, "./TransformHandle": 4, "./TransformMarker": 5 }]
}, {}, [6]);